...
Ein B-Baum ist ein vollständig balancierter Baum. In der Ordnung n (n = max. Anzahl Kinder) enthält jeder Knoten, ausser der Wurzel, mindestens (n-1)/2 und höchstens n-1 Schlüssel.
